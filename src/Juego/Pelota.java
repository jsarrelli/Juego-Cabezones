...
public class Pelota implements Dibujable {
	...
	public int getFuerzaDespeje() {
		return fuerzaDespeje;
	}



	public void setFuerzaDespeje(int fuerzaDespeje) {
		this.fuerzaDespeje = fuerzaDespeje;
	}
	...
	public boolean isEnvionActivado() {
		return envionActivado;
	}



	public void setEnvionActivado(boolean envionActivado) {
		this.envionActivado = envionActivado;
	}
